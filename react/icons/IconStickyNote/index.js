  ...
  render() {
    ...
    return (
      <svg
        ...
        viewBox="0 0 18 18"
      >
        <path  d="M15.5,0H2.5A2.5,2.5,0,0,0,0,2.5v13A2.5,2.5,0,0,0,2.5,18h9.84a4,4,0,0,0,2.83-1.17l1.66-1.66A4,4,0,0,0,18,12.34V2.5A2.5,2.5,0,0,0,15.5,0ZM1.5,15.5V2.5a1,1,0,0,1,1-1h13a1,1,0,0,1,1,1v8.85H13A1.68,1.68,0,0,0,11.35,13V16.5H2.5A1,1,0,0,1,1.5,15.5Zm12.61.27a2.48,2.48,0,0,1-1.46.7V13a.38.38,0,0,1,.38-.38h3.44a2.48,2.48,0,0,1-.7,1.46Z" fill={svgColor} />
      </svg>
    )
  }
}
